...
const Portfolio = () => {
    return (
        <div>
            <div name='Portfolio' className='flex flex-wrap items-center justify-center bg-gradient-to-b from-black to-gray-800 text-white h-full'>
                <div className='w-10/12 mb-20 '>
                    ...
                    <div>
                        <div className='grid grid-cold-1 md:grid-cols-2 place-items-center'>
                            <Cards name="Portfolio" image="/Portfolio.png" demo="" git="https://github.com/rakshitgondwal/portfolio-website" />
